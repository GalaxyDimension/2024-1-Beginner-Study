...
- 답: Merge: commit이 그대로 병합, Squash: 하나의 commit으로 병합, Rebase: commit의 base를 재설정, 모두 새로운 commit으로 변경
...
- 답: develop에서 작업중이다. commit은 docs: readme이다.
...
- 답: revert, reset은 commit을 삭제하므로 공유하는 브런치에도 영향을 미칠 수 있음.
